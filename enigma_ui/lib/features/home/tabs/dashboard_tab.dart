        ...
        child: CustomScrollView(slivers: [
          SliverAppBar(
            ...
            title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text('Your health today', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
            ]),
            actions: [
              Padding(
...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bg = Paint()..color = AppColors.divider..style = PaintingStyle.stroke..strokeWidth = 10..strokeCap = StrokeCap.round;
...
class _BreakdownCard extends StatelessWidget {
  ...
  static const _maxes = {
    'activity': 25, 'bmi': 25, 'heart': 15,
    'lifestyle': 15, 'sleep': 15, 'stress': 10,
  };
  static const _icons = {
    ...
    child: Column(
      children: breakdown.entries.map((e) {
        ...
        return Padding(
          ...
          child: Column(children: [
            Row(children: [
              Icon(_icons[e.key] ?? Icons.circle, size: 16, color: AppColors.primary),
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation(
                  pct > 0.7 ? AppColors.heartPts : AppColors.primary,
                ),
              ),
            ),
          ]),
...
class _RiskCard extends StatelessWidget {
  ...
  Color _riskColor(String level) {
    switch (level.toLowerCase()) {
      ...
      default:       return AppColors.heartPts;
    }
  }
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      children: risks.entries.map((e) => Expanded(
        child: Column(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _riskColor(e.value).withOpacity(0.1),
              borderRadius: BorderRadius.circular(20),
            ),
            child: Text(e.value,
                style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600,
                    color: _riskColor(e.value))),
          ),
        ]),
      )).toList(),
    ),
